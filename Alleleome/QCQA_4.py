...
def process_core_genes(pangenome_alignments_dir_path,alleleome_dir_path):
    """
    ...
    try:
        ...
        df1 = pd.read_csv(os.path.join(alleleome_dir_path, 'core_alleles_with_length_less_than_2std_less_than_mean_length.csv'))
