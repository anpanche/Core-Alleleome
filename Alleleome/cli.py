...
def main():
    ...
    try:
        ...
        parser.add_argument(
            "--path2",
            help="Path to alleleome output directory containing pangene_summary_v2.csv file generated by Roary",
        )
        parser.add_argument(
            "--table",
            help="Path to a custom CSV pangene summary table. If not provided, pangene_summary_v2.csv file (generated by Roary) in the given Alleleome output directory a will be used.",
            default=None,
        )
        parser.add_argument(
            "--log_to_terminal",
